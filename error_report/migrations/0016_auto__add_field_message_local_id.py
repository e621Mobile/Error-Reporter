...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.local_id'
        db.add_column(u'error_report_message', 'local_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.local_id'
        db.delete_column(u'error_report_message', 'local_id')
